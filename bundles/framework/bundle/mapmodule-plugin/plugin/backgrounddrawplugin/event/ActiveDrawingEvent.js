 ...
 */
Oskari.clazz.define('Oskari.mapframework.bundle.mapmodule.plugin.BackgroundDrawPlugin.event.ActiveDrawingEvent',
/**
...
function(geometry, mode, creatorId) {
    ...
    __name: "BackgroundDrawPlugin.ActiveDrawingEvent",
    /**
     * @method getName
     * Returns event name
     * @return {String}
