 ...
 */
Oskari.clazz.define('Oskari.mapframework.bundle.mapmodule.plugin.BackgroundDrawPlugin.event.FinishedDrawingEvent',
/**
...
function(geometry, blnEdit, creatorId) {
    ...
    __name: "BackgroundDrawPlugin.FinishedDrawingEvent",
    /**
     * @method getName
     * Returns event name
     * @return {String}
