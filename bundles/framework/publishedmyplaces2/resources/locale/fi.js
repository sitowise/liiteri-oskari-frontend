Oskari.registerLocalization(
{
  ...
  "value": {
    ...
    "placeform": {
            ...
            "tooltip": "Tallenna kohde omiin tietoihisi. Kohteelle on annettava vähintään nimi ja kuvaus. Lopuksi valitse karttataso, johon kohde tallennetaan, tai luo uusi karttataso.",
      "placename": {
    ...
    "pointform": {
            ...
            "tooltip": "Valitse pisteelle symboli, koko ja väri.",
            "symbol": {
                "label": "Symboli"
            },
            "size": {
        ...
        "lineform": {
            ...
            "tooltip": "Valitse viivoille tyyli, leveys ja väri.",
            "style": {
                "label": "Tyyli"
      },
      "cap": {
        ...
        "areaform": {
            ...
            "tooltip": "Valitse alueille reunaviivan tyyli, leveys ja väri sekä täyttöväri tai täyttökuvio.",
            "linestyle": {
    ...
    "notification": {
      ...
      "categorySaved": {
                ...
                "message": "Karttatasoon tehdyt muutokset on tallennettu."
      },
      "categoryDelete": {
                "title": "Karttatason poistaminen",
                "deleteConfirmMove": "Karttataso {0} sisältää {1} kohdetta. Haluatko poistaa karttatason ja siirtää sen kohteet oletuskarttatasolle {2} vai poistaa karttatason kohteineen?",
      ...
      "error": {
                "addCategory": "Karttatason tallentaminen epäonnistui. Myöskään kohdetta ei ole tallennettu.",
