...
OpenLayers.Control.LoadingPanel = OpenLayers.Class(OpenLayers.Control, {
    ...
    */
    ...
    /**
     * Name of layers on which loading panel should work
     */
    layerNames: [],
    /**
    ...
    */
    addLayer: function (evt) {
        if (evt.layer) {
            if ($.inArray(evt.layer.name, this.layerNames) > -1) {
    ...
    setMap: function (map) {
        ...
        $.each(this.layerNames, function (key, layerName) {
            var itemResult = map.getLayersByName(layerName);
