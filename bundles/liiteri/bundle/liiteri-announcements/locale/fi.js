Oskari.registerLocalization(
    {
        "lang": "fi",
        "key": "liiteri-announcements",
        "value": {
			"flyout": {
				"title": "Ilmoitusten ylläpito",
				"table": {
					"id": "ID",
					"title": "Otsikko",
					"message": "Viesti",
					"expiration": " Vanhenemispäivä",
					"operations": "Toiminnot"
				},
				"datatablelanguagefile": "Finnish.json",
				"error": {
				    "title": "Virhe",
				    "error": "Virhe ilmoituksen tallentamisessa",
				    "validation": "Täytä kaikki lomakkeen kentät"
				},
				"buttons": {
				    "next": "Seuraava",
				    "previous": "Edellinen",
