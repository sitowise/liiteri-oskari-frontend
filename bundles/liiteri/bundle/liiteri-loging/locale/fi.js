Oskari.registerLocalization(
    {
        ...
        "value": {
            ...
            "title": "Tervetuloa",
            "desc": "",
            "copyrightText": "&copy; Liiteri palvelu",
            "errorTitle": "Virhe",
            "tosErrorMessage": "Käyttöehtojen hyväksymisen tallentaminen epäonnistui. Yritä myöhemmin uudelleen.",
            ...
            "page1": {
                ...
                "continueAsGuestInfo": "Jatka palveluun ilman kirjautumista.",
                "rememberLogged": "Pidä minut kirjautuneena",
                "acceptConditions": "Hyväksy palvelun käyttöehdot",
                "register": "Rekisteröidy &#8250;",
                "forgotPassword" : "Hups, Unohdin salasanani",
                ...
                "incorrectLogin": "<strong>Sisäänkirjautuminen epäonnistui.</strong> Tarkista tunnus ja salasana.",
                "fillField": "Kentän tieto puuttuu",
            },
            "page2": {
                "title": "Hyväksy käyttöehdot",
                "message" : "Jatkamalla palvelun käyttöä hyväksyt <a href='http://www.ymparisto.fi/fi-FI/Elinympariston_tietopalvelu_Liiteri/Kayttoehdot' target='_blank'>käyttöehdot</a>.",
                "confirm" : "Hyväksy"
            },
            "page3": {
                "title": "Karttatasot",
