/**
 * @class Oskari.liiteri.bundle.liiteri-groupings.event.GroupingUpdatedEvent
 * 
 * Used to notify components that ... 
 */
Oskari.clazz.define('Oskari.liiteri.bundle.liiteri-groupings.event.GroupingUpdatedEvent', 
/**
